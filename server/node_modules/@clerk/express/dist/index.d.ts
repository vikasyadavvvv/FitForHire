...
import { SignedInAuthObject, SignedOutAuthObject, AuthenticateRequestOptions, RequestState } from '@clerk/backend/internal';
 ...
 */
declare const getAuth: (req: Request, options?: GetAuthOptions) => SignedInAuthObject | SignedOutAuthObject;
